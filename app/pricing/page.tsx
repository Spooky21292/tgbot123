...
const plans = [
  ...
  { id: 'learning', name: 'Learning', price: '499 ₽', period: '/мес', description: 'Полный доступ к обучению и библиотеке записей.', promo: 'Промокод: TESTPROMO', features: ['Все курсы и уроки', 'Тесты, прогресс и рекомендации', 'Все вебинары и доступ к записям', 'Telegram Bot включён в тариф'] },
  { id: 'family', name: 'Family', price: '999 ₽', period: '/мес', description: 'Для семьи с единым доступом к материалам.', promo: 'Промокод: TESTPROMO', features: ['До 3 пользователей в семье', 'Семейные сценарии и рекомендации', 'Архив вебинаров и семейный доступ к записям', 'Telegram Bot включён в тариф'] }
];
