...
const courseBlueprints: CourseBlueprint[] = [
  ...
  { title: 'Первая зарплата без хаоса: взрослый финансовый старт', slug: 'pervaya-zarplata-bez-haosa-vzroslyj-finansovyj-start', description: 'Курс для 18–25 о первой зарплате, структуре месяца, подписках и базовом резерве.', age: '18-25', level: 'beginner', cover: coverPool[4], isPremium: true, focus: 'первая зарплата и структура месяца', practical: 'День зарплаты используйте как точку распределения денег, а не как старт спонтанных трат' },
  ...
  { title: 'Финансовая безопасность в цифровой среде', slug: 'finansovaya-bezopasnost-v-cifrovoj-srede', description: 'Курс о картах, маркетплейсах, подписках, фишинге и бытовой цифровой дисциплине.', age: '18-25', level: 'beginner', cover: coverPool[5], isPremium: true, focus: 'безопасность цифровых денег', practical: 'Возвращайте себе паузу перед любой онлайн-оплатой и проверяйте источник' },
  ...
  { title: 'Семейный бюджет без взаимных претензий', slug: 'semejnyj-byudzhet-bez-vzaimnyh-pretenzij', description: 'Большой курс о совместных деньгах, ролях, целях и семейных правилах.', age: '26+', level: 'intermediate', cover: coverPool[2], isPremium: true, focus: 'семейный бюджет и договорённости', practical: 'Проводите короткий семейный финансовый разговор в спокойное время, а не после конфликта' },
  { title: 'Инфляция, цены и покупательная способность без паники', slug: 'inflyaciya-ceny-i-pokupatelnaya-sposobnost-bez-paniki', description: 'Курс о влиянии инфляции на повседневные решения, цели и структуру накоплений.', age: '26+', level: 'intermediate', cover: coverPool[3], isPremium: true, focus: 'инфляция и повседневные решения', practical: 'Раз в квартал обновляйте стоимость крупных целей и семейных обязательств' },
