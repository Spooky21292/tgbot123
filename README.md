...
## Быстрый запуск через index.html
В корне проекта добавлен `index.html` — это локальный launcher с кнопками на основные страницы (курсы, блог, кабинет, вебинары, бот, тарифы, трейдинг).

Как использовать:
1. Запустите Next.js-приложение (`npm run dev`).
2. Откройте файл `index.html` в браузере.
3. Используйте кнопки для перехода на нужные маршруты `http://localhost:3000/...`.

Важно: `index.html` не заменяет Next.js сервер — это только удобная стартовая страница-навигация.
